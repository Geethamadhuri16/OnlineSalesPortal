<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="product.ProductDao,java.util.ArrayList,product.Product" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<title>SteelRods</title>
...
<div class="container my-5">
  ...
  ArrayList<Product> products=p.displayByCategory("5516501d-2a18-47b5-a5b1-ae0295961cce");
