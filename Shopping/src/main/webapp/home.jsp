...
<jsp:include page="header.jsp"></jsp:include>
  ...
  function handleClickAdd(proid) {
      var pro_Id1 =proid ;
      // Make an AJAX request to send the pro_Id to the server-side
      var xhr1 = new XMLHttpRequest();
      xhr1.open("POST", "AddToWishList", true);
      ...
      xhr1.send("product_id=" + encodeURIComponent(pro_Id1));
    }
...
<div class="container my-5">
  ...
  <h6 class="mb-1 me-1" style="color: blue;"><%=product.getPrice() %></h6>
                ...
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  ...
                  <a  class="btn btn-light border icon-hover px-2 pt-2" style="margin-left: 220px" onclick="handleClickAdd('<%=product.getProductid() %>')"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                </div>
              </div>
            </div>
          </div>
